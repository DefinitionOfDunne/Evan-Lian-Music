...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(158); //render engine
	var Landing = __webpack_require__(159);
	var Covers = __webpack_require__(162);
	var Contact = __webpack_require__(164);
	var Bio = __webpack_require__(165);
	var Gallery = __webpack_require__(166);
	var Layout = __webpack_require__(169);
	var ReactRouter = __webpack_require__(171);
	...
	var App = function App() {
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(Route, { path: '/covers', component: Covers }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Brand = __webpack_require__(161);

	var Landing = function Landing() {
	  return React.createElement(
	    'div',
	    null,
	    React.createElement(Header, { title: 'Evan Lian Music' })
	  );
	};
	...
	var Brand = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('img', { src: 'public/img/evan-brand.png', className: 'logo' }),
	      React.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Header = __webpack_require__(160);
	var songs = __webpack_require__(163);

	var Covers = React.createClass({
	  displayName: 'Covers',
	  render: function render() {
	    var covers = songs.covers.map(function (song) {
	      return React.createElement(
	        'li',
	        { className: 'covers-li', key: song.id },
	        React.createElement(
	          'h2',
	          null,
	          song.title
	        ),
	        React.createElement('iframe', { src: 'https://www.youtube.com/embed/' + song.link + '?autoplay=0', frameBorder: '0' })
	      );
	    });
	    return React.createElement(
	      'div',
	      { className: 'title' },
	      React.createElement(Header, { title: 'Covers Page' }),
	      React.createElement(
	        'ul',
	        { className: 'cover-ul-wrapper' },
	        ' ',
	        covers,
	        ' '
	      )
...
/***/ function(module, exports) {
	...
	module.exports = {
		"covers": [
			...
			{
				"title": "Wild Ones/Call Me Maybe (ft. Braydizz)",
				"id": "5",
				"link": "3Q9MqmksHdo"
			},
			{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Contact = function Contact() {
	  return React.createElement(
	    'div',
	    { className: 'title' },
	    React.createElement(Header, { title: 'Contact Me Page' })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bio = function Bio() {
	  return React.createElement(
	    'div',
	    null,
	    React.createElement(Header, { title: 'Bio Page' }),
	    React.createElement(
	      'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImageGallery = __webpack_require__(167);
	  ...
	  _createClass(ImageGallery, [{
	    ...
	    value: function render() {
	      ...
	      this.props.items.map(function (item, index) {
	        ...
	        if (_this7.props.showThumbnails) {
	          thumbnails.push(_react2.default.createElement('a', {
	            ...
	            onError: onThumbnailError.bind(_this7) }), _react2.default.createElement('div', { className: 'image-gallery-thumbnail-label' }, item.thumbnailLabel)));
	        }
	      ...
	      return _react2.default.createElement('section', {
	        ...
	        className: 'image-gallery' + (modalFullscreen ? ' fullscreen-modal' : '') }, _react2.default.createElement('div', { className: 'image-gallery-content' + (isFullscreen ? ' fullscreen' : '') }, _react2.default.createElement('div', { className: 'image-gallery-slide-wrapper' }, this.props.showFullscreenButton && _react2.default.createElement('a', {
	        className: 'image-gallery-fullscreen-button' + (isFullscreen ? ' active' : ''),
	        onClick: this._toggleFullScreen.bind(this) }), this.props.showPlayButton && _react2.default.createElement('a', {
	        ref: function ref(p) {
	          return _this7._playButton = p;
	        },
	        className: 'image-gallery-play-button' + (isPlaying ? ' active' : ''),
	        onClick: this._togglePlay.bind(this) }), this._canNavigate() ? [this.props.showNav && _react2.default.createElement('span', { key: 'navigation' }, _react2.default.createElement('button', {
	        className: 'image-gallery-left-nav',
	        disabled: !this._canSlideLeft(),
	        onTouchStart: slideLeft,
	        onClick: slideLeft }), _react2.default.createElement('button', {
	        className: 'image-gallery-right-nav',
	        disabled: !this._canSlideRight(),
	        onTouchStart: slideRight,
	        onClick: slideRight })), this.props.disableSwipe ? _react2.default.createElement('div', { className: 'image-gallery-slides', key: 'slides' }, slides) : _react2.default.createElement(_reactSwipeable2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Navbar = __webpack_require__(170);
	...
	var Layout = function Layout(props) {
	  return React.createElement(
	    ...
	    React.createElement(Navbar, { classname: 'header-nav' }),
	...
	var Footer = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'footer' },
	      React.createElement(Navbar, { classname: 'footer-nav' }),
	      React.createElement('div', { className: 'random-div' }),
	      React.createElement(
	        'div',
	        { className: 'social-media-links' },
	        React.createElement(
	          'a',
	          { className: 'footer-item', href: 'https://www.facebook.com/evan.lian.5', target: '_blank' },
	          'Facebook'
	        ),
	        React.createElement(
	          'a',
	          { className: 'footer-item', href: 'https://twitter.com/EvanWill1ams', target: '_blank' },
	          'Twitter'
	        ),
	        React.createElement(
	          'a',
	          { className: 'footer-item', href: 'https://soundcloud.com/evahnsan', target: '_blank' },
	          'Soundcloud'
	        )
	      )
	    );
